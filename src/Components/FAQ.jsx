  ...
  return (
    <div className='section w-full h-auto flex justify-center items-center my-12'>
      <div className="container w-[90%] h-auto flex flex-col items-start justify-start">
        <div className='w-[97px] h-[35px] flex justify-center items-center font-[Inter] font-[700] text-[48px] leading-[58.09px] tracking-[0.5%] text-transparent bg-clip-text bg-gradient-to-b from-[#06286E] to-[#164EC0]'>FAQ</div>
